...
export default function Main(props: any) {
  ...
  return (
    <Layout>
      <h4 onLoad={() => setloaded(true)} className={`font-bold ${loaded ? 'text-red-50' : 'text-black'} animate-ping animate-bounce hover:blur-3xl left-0`}> From docker HMR 98: RPI CSR/SSR template {props.value}</h4>

      <span className="font-normal hover:border-l-indigo-600 hover:animate-bounce animate-pulse">
        Hell span;
      </span>

      <h5 className=" animate-ping blur-3xl ">
        Toto
      </h5>
